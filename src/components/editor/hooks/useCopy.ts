...
export const useCopy = () => {
  ...
  const copyToClipboard = useCallback(async (contentElement: HTMLElement | null) => {
    ...
    try {
      ...
      ;(window as Window & {
        __NEURAPRESS_LAST_COPIED_HTML__?: string
        __NEURAPRESS_LAST_COPIED_TEXT__?: string
      }).__NEURAPRESS_LAST_COPIED_HTML__ = processedContent
      ;(window as Window & {
        __NEURAPRESS_LAST_COPIED_HTML__?: string
        __NEURAPRESS_LAST_COPIED_TEXT__?: string
      }).__NEURAPRESS_LAST_COPIED_TEXT__ = plainText
